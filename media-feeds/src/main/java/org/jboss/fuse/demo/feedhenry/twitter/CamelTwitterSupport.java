...
/**
 * @author Scott England-Sullivan
 * 
 */
public class CamelTwitterSupport extends DefaultCamelContext {
	...
	public CamelTwitterSupport() {
		...
		try {
			...
			throw new IllegalAccessError(
					"twitter-options.properties could not be found");
		}
